...
You can see that for some candidates, for example Joe Biden or Beto O'Rourke, cable news and online media coverage tracks relatively closely. Coverage diverges more sharply for other candidates, such as Elizabeth Warren, Bernie Sanders, or Pete Buttigieg.
...
It's important to note that in this race, all news is NOT good news. FiveThirtyEight's dataset only tracks total coverage, not it's sentiment - good or bad. And increased coverage invites additional scrutiny. 
