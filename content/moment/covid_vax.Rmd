...
ggplot(map_data, aes(x = long, 
  ...
  labs(x = NULL, 
       ...
       caption = "Data from U.S. Department of Health and Human Services (Pfizer and Moderna doses allocated); state surveys and announcements (doses confirmed received and shots given).",
       fill = NULL) +
...
ggplot(bar_stats, aes(x= state, y = value, fill = factor(metric, levels = unique(metric)))) +
