...
while(current_herd_total <= 231) {
  ...
  add_row <- data.frame(date,seven_day_average_rate + seven_day_average_covid_case_rate)
  
  names(add_row) <- c("date","protection_mil")

  full_herd_projection <- rbind(full_herd_projection,add_row)
  
  current_herd_total <- current_herd_total + seven_day_average_rate + seven_day_average_covid_case_rate
  date <- date + 1
}
...
**At the rolling seven-day average vaccination and case rates, the U.S. is projected to achieve herd immunity `r herd_date`.**    
...
- [NY Times vaccine distribution data](https://www.nytimes.com/interactive/2020/us/covid-19-vaccine-doses.html)  
