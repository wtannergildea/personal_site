...
But forget goals - what if the U.S. distributed all the vaccine supply promised to it by Moderna and Pfizer (220 million doses by end of Q1 2021)? We could hit herd immunity by early June.  
```{r Q1 figure, echo = FALSE, message=FALSE, warning=FALSE,fig.align='center'}
knitr::include_graphics("Q1_supply_herd_date.png")
```
