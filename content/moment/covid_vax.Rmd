...
ggplot(map_data, aes(x = long, 
  ...
  labs(x = NULL, 
       ...
       subtitle = paste0("Approximately ", cdc_vax_total," million Americans vaccinated since December 2019."),
...
```
To achieve herd immunity by Covid infection alone, as some fringe public health commentators and right-wing politicians have suggested the U.S. do, 
### approximately `r deaths_to_herd` more Americans would die

## Vax distribution in states
