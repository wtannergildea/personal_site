...
ggplotly(ggplot(covid_summary, aes(x = state, 
  ...
  layout(hoverlabel = list(bgcolor = "white",
         ...
         title = list(text = paste0('Percent of state population diagnosed with Covid to date',
                                    '<br>',
                                    '<sup>',
                                    'Hover over figure for precise percentages',
                                    '</sup>'),
                      x = 1.5))
```
...
master_summary <- covid_summary %>%
  ...
  mutate(perc_vax_given = round(100*shots_given/doses_received,2))
...
tooltip = "text") %>%
  ...
  layout(hoverlabel = list(bgcolor = "white",
                           font = list(family = "Georgia")),
         title = list(text = paste0('Vaccine allocation and distribution',
                                    '<br>',
                                    '<sup>',
                                    'Hover over figure for % of received shots given',
                                    '</sup>')))
