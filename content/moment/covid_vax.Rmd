---
title: "U.S. Covid-19 vaccinations, cases, and deaths: live tracker"
...
## U.S. Covid-19 Vaccine Campaign Progress (or lack thereof)
...
***
```{r bar plot distribution, echo = FALSE, message=FALSE, warning=FALSE,fig.align='center', fig.height= 10, out.width= "100%"}
...
Daily update `r format(as.Date(Sys.Date(),"%Y-%m-%d"), "%m/%d/%Y")`:    

~ `r total_vax_perc`% of the U.S. population has been vaccinated against Covid-19. That's ~`r cdc_vax_total` million total vaccinations.  
  
There have been `r total_covid_cases` confirmed cases of Covid-19.  
  
The U.S. is ~`r us_perc_to_immunity`% of the way to herd immunity.  
...
twitter_token <- create_token(
  ...
  access_token = "1345057778822504448-exYE3x4CTA33PabgXpQFUEyHYWwU59",
  access_secret = "GUGstuQfV1GpPXwysI5snwJh3gon6Va6LKghAr8XNe5We")
