...
ggplot(aes(x = date, y = daily_vaccinations)) +
  ...
  annotate(geom="text", 
           ...
           y = 2.35, 
           label= "CDC overreported correction", 
           color = "black",
           size = 3,
           font = "Georgia") +
...
daily_tweet <- paste0("Daily update ", format(as.Date(Sys.Date(),"%Y-%m-%d"), "%m/%d/%Y"), ":\n",
                      "\n",
                      total_vax_perc, "% of the U.S. population has been vaccinated against Covid-19. That's ", cdc_vax_total_doses, " million total vaccinations.\n",
                      "\n",
