---
title: "U.S. Covid-19 vaccinations, cases, and deaths"
...
## U.S. Covid-19 Vaccination Progress
...
vax <- vax_html_raw %>%
  ...
  html_table() %>%
  rename(state = 1) %>%
  rename(doses_allocated = `First doses allocated`,
         doses_received = `Doses distributed`,
...
ggplot(map_data, aes(x = long, 
  ...
  labs(x = NULL, 
       ...
       subtitle = paste0("Assuming 70% herd immunity threshold and protection against re-infection.\nEstimated from confirmed vaccinations and infections. \nExpect lag in reported vaccinations, and significant undercount in confirmed infections."),
...
bar_stats <- master_summary %>%
  ...
  rename('Doses allocated' = doses_allocated,
